...
<#
.SYNOPSIS
Retrieves one or more entities from the Computer entity set.
...
.EXAMPLE
Get-Computer -ListAvailable -Select Name

Retrieves the name of all Computers.


.EXAMPLE
Get-Computer Server1 -Select Parameters -ValueOnly -ConvertFrom-Json

Retrieves the Computer 'Server1' and only returns the 'Parameters' property 
of it. In addition the contents of the property will be converted from JSON.


.EXAMPLE
Get-Computer -ListAvailable -Select Name -First 3

Retrieves the name of the first 3 Computers.


.EXAMPLE
Get-Computer 4005 -Select Name -ValueOnly

Retrieves the name of the Computer with Id 4005.


.EXAMPLE
Get-Computer -ModifiedBy Administrator -Select Id, Name

Retrieves Id and Name of all Computers that have been modified by user 
with name 'Administrator' (case insensitive substring match).


.EXAMPLE
Get-Computer Server1 -Select Description -ValueOnly -DefaultValue 42

Retrieves the 'Description' property of a Computer with Name 'Server1' 
and 42 if the entity is not found.


.LINK
Online Version: http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-Computer/
...
[CmdletBinding(
    ...
    ConfirmImpact = "Low"
	,
	HelpURI = 'http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-Computer/'
	,
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Get-Computer; } 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU1FV0aVaQ3waZWxbObE8X8CUo
# /wCgghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBT9UizJLWckHnWwRYct
# XI0SUGucfjANBgkqhkiG9w0BAQEFAASCAQC32Hu7EThIx9fDLM/jWK6LT1cc2ure
# 0slZ4r8o/KyuF47P8UOINEMCm+ck1Ffp56Ujkgos9aKW/plYn6uQkOFRzQ+tVsQn
# SzFkQm6Ut/KJAo1ZtlrXwWG/haQgWrtJxqs2cuX6RZJT4yjX7FMlhLRivpo5hFq2
# RdEdBpC+KfNTb+vpZ6MXmtg1z5kkyS/+REZxAgvDtYuTw2S42ORWy9KtL6MrvRhz
# nqokvdil2tPhOC9peKDd9X4LzRwjX+8vyOQIeja1K9PvEO4X8qPXgVgV4Sdu5Yde
# tsNuo8DaWTk/HUg1P0tDH+sGB5ABLwky8Uf8CG6/WkioXYs4RjW8SVveoYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE1MDEx
# NDA5Mjc1OVowIwYJKoZIhvcNAQkEMRYEFDjXvbTZk3cU8XEPXGfI7gH8kDhNMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQCtdSzYfkj6Akf0jMPFJCft
# 7h/B6JCrHh+6hq8wYbEp+fjWyhN9w5PcgjVI2iFlLzHXlpCm/jAOwFBqnnfFXXzt
# B38bBG2isco6SqqJU8rFeLm7yPZukkQvdhzYf0cFydbGLowXVKYj1jqzOBM7FZjF
# 9h8IeTiBlHBsEjW7tpbDv6rNNZU3ynzX/JrZGW0KutKbcCxnIVQveoIUSBBVkLFk
# wcp+lgpQvWkea9yMvRYpV60G2zGq5GFzzD49auY/BUWkwwbCryECN7gujT4dx856
# 0Str+kcOUpdQTnv4mRKwg0yJQmpw3kmmuQ3LY/F9NqcpZjiEkZr39Aay1NFjt7QM
