function Get-AppScreen {
<#
.SYNOPSIS
Retrieves one or more entities from the AppScreen entity set.
...
.EXAMPLE
Get-AppScreen -ListAvailable -Select Name

Retrieves the name of all AppScreens.


.EXAMPLE
Get-AppScreen myvCenter -Select Description -ValueOnly -ConvertFrom-Json

Retrieves the AppScreen 'myvCenter' and only returns the 'Description' property 
of it. In addition the contents of the property will be converted from JSON.


.EXAMPLE
Get-AppScreen -ListAvailable -Select Name -First 3

Retrieves the name of the first 3 AppScreens.


.EXAMPLE
Get-AppScreen 4005 -Select Name -ValueOnly

Retrieves the name of the AppScreen with Id 4005.


.EXAMPLE
Get-AppScreen -ModifiedBy Administrator -Select Id, Name

Retrieves Id and Name of all AppScreens that have been modified by user 
with name 'Administrator' (case insensitive substring match).


.EXAMPLE
Get-AppScreen SystemAdministration -Select Value -ValueOnly -DefaultValue 42

Retrieves the 'Value' property of a AppScreen with Name 'SystemAdministration' 
and 42 if the entity is not found.


.LINK
Online Version: http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-AppScreen/
...
[CmdletBinding(
    ...
    ConfirmImpact = "Low"
	,
	HelpURI = 'http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-AppScreen/'
	,
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Get-AppScreen; } 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUG1p0X89zdgGoz+yo5tmeYu40
# hB2gghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRivCYCiMT+k9g31AVW
# ZCnBZBCB8zANBgkqhkiG9w0BAQEFAASCAQAFZ8ai61OtSeAwnBkdSZ7AptdfRVYU
# S0nAcBp+COcZhI86BkWkzbmuWUNGVqDt7Th0eRw2mKvXzjGfvgDVCIUccZgs5bbj
# gP1pbwkax7se9KGb3fx5FtxMgAY1s8hWoXaU+z0zRaajyDlfnrbMXBhypeaP1PWt
# SAiUjsUMoa8U06jAoTSIhq/XWntQ3QkK4sPHgG5diwVPm5f04nU8HPtB+zC31Ugk
# qpeJUAk0R2mArZUfQ+ZGhBYmy+5hJ5dAtUyDkpxG87/mAF80cmL/E+Nzjl31aEK+
# DoCGGHlueraDtTeRpXRVBItlgVKl+KiGQDEd8hi5Q/D0weX64SIwr/jvoYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE1MDEx
# NDA5Mjc1OFowIwYJKoZIhvcNAQkEMRYEFCryLrvmAvmHAfYP6gtbp3LMhrbSMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQBAuY9xGqf+kFKfI+vYt1zq
# U3iR1i4hk8TtyvV7MwkL4grkKkeSSpstQIPwSEzv2VNyXRYXZFW1sUDHHv7aokSB
# VGxA5tNfdjdwskYur9uVlcuxwoteOmz7K+uL2UgaOkuFi0Z3iU3hzcB8Ma766Pk6
# auGEm2xdrUtFqyqDBah2FLRfDtZ68sgKNNm26BTH2GhwXbDK1ju3zhtCzaYsogop
# uVVhPC6bYiWZ9OXLPIWaaHnr8eiZGftI0xVoVtJbpWt6pVn3VVCpFdwXg21g+VWT
# K8ARY8BMOabUw5NMZxE1H7OySP57v8vffE3w8b/cLxqLr0p2g/me3XD3rxT7Mnlk
