...
<#
.SYNOPSIS
Retrieves one or more entities from the Site entity set.
...
.EXAMPLE
Get-Site -ListAvailable -Select Name

Retrieves the name of all Sites.


.EXAMPLE
Get-Site PROD -Select Description -ValueOnly -ConvertFrom-Json

Retrieves the Site 'PROD' and only returns the 'Description' property 
of it. In addition the contents of the property will be converted from JSON.


.EXAMPLE
Get-Site -ListAvailable -Select Name -First 3

Retrieves the name of the first 3 Sites.


.EXAMPLE
Get-Site 4005 -Select Name -ValueOnly

Retrieves the name of the Site with Id 4005.


.EXAMPLE
Get-Site -ModifiedBy Administrator -Select Id, Name

Retrieves Id and Name of all Sites that have been modified by user 
with name 'Administrator' (case insensitive substring match).


.EXAMPLE
Get-Site PROD -Select Description -ValueOnly -DefaultValue 42

Retrieves the 'Description' property of a Site with Name 'PROD' 
and 42 if the entity is not found.


.LINK
Online Version: http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-Site/
...
[CmdletBinding(
    ...
    ConfirmImpact = "Low"
	,
	HelpURI = 'http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-Site/'
	,
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Get-Site; } 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQULCUnuMyK+zdYV+ts4F9TZQKU
# +3CgghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBT58kdA5L50rwqk4NWc
# /p/vAcxeuTANBgkqhkiG9w0BAQEFAASCAQBO0lciXmB2x2otN9Nb3cuqo9CJrRlt
# rAM4LIXbg8wHPeq+sxu/JKGO25SNXnc9K/wU7W6C9Cto1LJKTrXpoxNTIzsqZLOz
# ICNXFhFa/IA/Gl7dSMt/kgoYP7xxm+h5c7z/QOtI7lHrcrLdlHVZatWXHFw1Pk9x
# p4NwGvLWiatuUl5dsEVuJpLc97uH6WEwseb3edO/2mh1swHJQ4Lztlmi2Fuy9JEr
# yCWHaGdYORYyzXArms5QvICOoj98ufwW8tDVOqfWXFgh7CgK0ANGx/9+1kId89dk
# rl5X+tihZH2PnnBeuqh08rGw7KeBJdg0e4dex9zipq0B8qGY2uzv0eU1oYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE1MDEx
# NDA5MjgwMVowIwYJKoZIhvcNAQkEMRYEFEE38A1GnEQqDCmwLgkH7xPeDhFMMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQBbAhaXthWvvYVYrk3T3dBb
# 0EefoE3yKSaTmuMhLoFrNkeG09UuIkDjwzfQ+B2lfqHrlpXBdRjoVIWvl+webDzA
# VWLtkkQvL/r+6djmivC56Yty9jm+FQZuKfbyAVaK6SSw+o7BT3S9EeEPv3Pbn5NT
# uYSt88I/+UDD1U23RhtP0hse+43nYOc4EPjBcNRvOAB2GwqpPXgCbq8t1hrvyIqR
# TGpI4vXC1nCSwLdteygchfboEG5XKRUw+Nlis9nzMmNBZZoHvHuPDNpQZXNgROYj
# xxCivrejcLT8sEPm+fhXkSXFWf4NCuqOML8BluDDS2jWMsUloY5hG5DIl8cEKnJO
