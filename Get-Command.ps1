...
<#
.SYNOPSIS
Retrieves one or more entities from the Command entity set.
...
.EXAMPLE
Get-Command -ListAvailable -Select Name

Retrieves the name of all Commands.


.EXAMPLE
Get-Command PingTest -Select Parameters -ValueOnly -ConvertFrom-Json

Retrieves the Command 'PingTest' and only returns the 'Parameters' property 
of it. In addition the contents of the property will be converted from JSON.


.EXAMPLE
Get-Command -ListAvailable -Select Name -First 3

Retrieves the name of the first 3 Commands.


.EXAMPLE
Get-Command 4005 -Select Name -ValueOnly

Retrieves the name of the Command with Id 4005.


.EXAMPLE
Get-Command -ModifiedBy Administrator -Select Id, Name

Retrieves Id and Name of all Commands that have been modified by user 
with name 'Administrator' (case insensitive substring match).


.EXAMPLE
Get-Command PingTest -Select Parameters -ValueOnly -DefaultValue 42
...
.LINK
Online Version: http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-Command/
...
[CmdletBinding(
    ...
    ConfirmImpact = "Low"
	,
	HelpURI = 'http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-Command/'
	,
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Get-Command; } 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU0b1oLM8q4HkRdrkDM5e7CEfg
# 3iegghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQf3D5pH6noV7camF3i
# 6GjADRvy2jANBgkqhkiG9w0BAQEFAASCAQB9TjynfTJO3XfNgVT7arptrxrCXTsJ
# ScGt66nMmOpUmakbCn/SExhkgmqjuq/LY4pRhSSp7couQLmrvUHV2DDqhHBVmk90
# ckIjm2WHgrQxDSLz9uyUvXdLdoS3PcCJIe/SIS5M0xm7AF5ImgCOWAYDJ6GZAHOr
# 4MoVNnuNPwHRnzZc969nlcQKmohM+Xp4zH88G5VldgWgQZAXRXC6RzlejGZp2+hx
# mvkPPn0T4ryW5PRKQeRTeV3CAD2YHM4zD851EJdnV48UdPmMSb8jdIeB5bGtNRfq
# vIsQFosSsKT14OsrrjQq+jmmrM83DtHtLliyk8hi2icoOWXlz36BG7qfoYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE1MDEx
# NDA5Mjc1OVowIwYJKoZIhvcNAQkEMRYEFPfvpNxnJsn/CAexALuKUV62ssJvMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQBJjw7nUHZQ8pl1XUZ0Vy5k
# vXXTDM19l2Gsnpi7vZ6m09KOASl2FAICH84DzTZtp5E975Q06Pq88EQ8YXrlY2Dp
# N7u0q9bGIxpsJDILJOiNk94DVxwISvdNBGAfcn9RLfbd2B4f/cYfL3QWLUMWLmHP
# Rb56kwsRP8JLT2UpZxUIV8piR9VTYw1EfsueoDUTKX5vl+5pfyA+6J5wMslc92DO
# kvQVq0ODn/Qk38CGh1Gdbbn04ratPQSHuXK8po5vx4BSD3tCxB2qoh9uAuQjD8Jl
# DQEJbZmLFYGjG9x5eVywUKJvX7JhsaaC+yoMGqNpii7MFw1NvsiU/XkwaEYSqLFL
