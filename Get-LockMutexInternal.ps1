function Get-LockMutexInternal {
<#
.SYNOPSIS
Retrieves one or more entities from the LockMutexInternal entity set.
...
.EXAMPLE
Get-LockMutexInternal -ListAvailable -Select Name

Retrieves the name of all LockMutexInternals.


.EXAMPLE
Get-LockMutexInternal DispatchMutex -Select Description -ValueOnly -ConvertFrom-Json

Retrieves the LockMutexInternal 'DispatchMutex' and only returns the 'Description' property 
of it. In addition the contents of the property will be converted from JSON.


.EXAMPLE
Get-LockMutexInternal -ListAvailable -Select Name -First 3

Retrieves the name of the first 3 LockMutexInternals.


.EXAMPLE
Get-LockMutexInternal 4005 -Select Name -ValueOnly

Retrieves the name of the LockMutexInternal with Id 4005.


.EXAMPLE
Get-LockMutexInternal -ModifiedBy Administrator -Select Id, Name

Retrieves Id and Name of all LockMutexInternals that have been modified by user 
with name 'Administrator' (case insensitive substring match).


.EXAMPLE
Get-LockMutexInternal DispatchMutex -Select Description -ValueOnly -DefaultValue 42

Retrieves the 'Description' property of a LockMutexInternal with Name 'DispatchMutex' 
and 42 if the entity is not found.


.LINK
Online Version: http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-LockMutexInternal/
...
[CmdletBinding(
    ...
    ConfirmImpact = "Low"
	,
	HelpURI = 'http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-LockMutexInternal/'
	,
...
BEGIN 
{
	...
	$EntitySetName = 'LockMutexInternals';
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Get-LockMutexInternal; } 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUWPeZweEohzXBQiK/3MHhBjiA
# vg6gghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTb+HF9qUDLAw69TGiF
# SRsHd947TDANBgkqhkiG9w0BAQEFAASCAQBlro1xtmKpEO9/S1YoOkDkCsALx1g5
# Apymel8lLuJpN5Un7su/41D6o2bOnYBbgvHpmr6CUXI4PjosBe0E3ea0EGWp98G5
# cXWAilp3BK7YvNMd50zHchWhOqUmue1X11IaWdUKYZ4qHoAH5sin8oTJ/94c8kTk
# pwWVS6ePjhVdHqkMLRx9LvRlGFE5enFiXctfZXefRcUPias3IXC4SDoD/iHbKXO4
# gQSjoZpvua03un8c9fq6xeztDoNgcc386cxWBpt3n9GyZdVX0ewWQop+wxGwzSCl
# G133hHxpfUKub2F8r66l8rCbPq6eJUVrNf14EY3w5M6DONMly9SWuFqEoYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE1MDEx
# NDA5Mjc1OVowIwYJKoZIhvcNAQkEMRYEFKf4axK57OooDH0p0rPb1XcgkJI/MIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQCHmkBR5uu8NQ+STUmK/BAH
# JT6s1GsjvOPiSF/Q6zMCnZtKl06SkBTsdd9DDu8J/8EtWXerESRSy+fLOBPVSCH8
# mWgecpdcoefJDrLuGWyNC2QCGUd3NihbuhQ+ViAabu+w1tFo67amZD0/P8LP9eXu
# /5iU1NPmxpD4lOWM4ocQowo3zywXP/sDFS8NJ52aNvtaTVGY0yNhp7lEHfhomEes
# pI8SJrys0+jZw8HmOm3sxjfC4/qPGRXn0mZ0i1lOgrg0sgRjTH+NeVbBz8korO8Y
# i6zuyg2jL8NlSqPG1vVT2E67XjiVFgz0Zkg2k7C6V8vmafVdZ1vM6supWlmKagpl
