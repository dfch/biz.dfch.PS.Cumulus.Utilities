...
try {
	...
	$files = $svc.ApplicationData.Files.AddQueryOption('$filter',$FilterExpression);
	$r = @();
	foreach($item in $files) {
		$itemString = '{0} [{1}]' -f $item.Name, $item.Version;
		if($PSCmdlet.ShouldProcess($itemString)) {
			$r += ($item | Select -Property Name, Version, Checksum);
...
# cwugghcbMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFEGz
# XZwcrXDn390AWQG4Qgr+OlkeMA0GCSqGSIb3DQEBAQUABIIBAE1Ata6rZAVoNozz
# pglgEt6ZazNPOU3TRShGOAZ/ZDJdFktT0CADQCEoPgzHu4mvC50ylZr5sFXkrFco
# 3qdcDpKie3Sm59pGzY5HJlb1RQgf2CLaYKBHeyEe+6fYPgnXNgEMFSj5JbDhH6Kl
# +eOEy0srMX+LbKWG0kVCEUb+YVuKFQ/cdoY8LnnPF5pZjG9VMxeCruh2JkfeBOxM
# tDKVng3EPBgbJiiUuTway66PMkRjvxWky3iwdJruADJF/XSThafz0MCO+fdnpExY
# lHTTLyoWCMYa+lCorbOKzJSRiDog1zRzddUe1KrpP+A8eOEfxdVOPIHgmasTmsYZ
# +/XxolOhggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEwaDBSMQswCQYDVQQG
...
# CQUxDxcNMTQxMTE2MDgwNTAyWjAjBgkqhkiG9w0BCQQxFgQUgg5FSM6gQqjJAsX5
# PP7L/IY4ydEwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGEBBSM5p9QEuHRqPs5
...
# LSBHMgISESFAXB8O0liIK+VNhoa6EepFMA0GCSqGSIb3DQEBAQUABIIBAEnCglhC
# lzldYi2HPjG08ZsPpY0qciXAH1MWAKHHvS25eIHyryQBFalrnZFVx/KlRmUWHpuq
# 5Bv7LW91OJivYRQEmXV4CZrCHpbu8D4pOiyFnhGrAuxY+SJ9LBgNusXbXxjSqEtO
# 6HJoeBaO9e++uhaOLBPjtVwAl3fkJpAoY5pRAU+kGl5lvho9Pk8gNj/++QmFO8KV
# FmTvTs/xfISqe0XNGOgG2migpjMiuhsfoMAH/pWqs2Wh3S3+CBRdHDEBMBHDb8ns
# ILo4zEY+3dJroDkFygdUpzuQxEslC0vXjnc/2FrWrmYM9umDBRbzliGKGRNyd85T
# nJbTpRrvrM48O5k=
