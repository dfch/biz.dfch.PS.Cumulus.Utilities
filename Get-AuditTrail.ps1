...
<#
.SYNOPSIS
Retrieves one or more entities from the AuditTrail entity set.
...
.EXAMPLE
Get-AuditTrail -ListAvailable -Select Name

Retrieves the name of all AuditTrails.


.EXAMPLE
Get-AuditTrail FunctionName -Select Message -ValueOnly -ConvertFrom-Json

Retrieves the AuditTrail 'FunctionName' and only returns the 'Message' property 
of it. In addition the contents of the property will be converted from JSON.


.EXAMPLE
Get-AuditTrail -ListAvailable -Select FunctionName -First 3

Retrieves the name of the first 3 AuditTrails.


.EXAMPLE
Get-AuditTrail 4005 -Select FunctionName -ValueOnly

Retrieves the name of the AuditTrail with Id 4005.


.EXAMPLE
Get-AuditTrail -ModifiedBy Administrator -Select Id, Message

Retrieves Id and Message of all AuditTrails that have been modified by 
user with name 'Administrator' (case insensitive substring match).


.EXAMPLE
Get-AuditTrail ComputersInserting -Select Message -ValueOnly -DefaultValue 42

Retrieves the 'Message' property of a AuditTrail with Name 'ComputersInserting' 
and 42 if the entity is not found.


.LINK
Online Version: http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-AuditTrail/
...
[CmdletBinding(
    ...
    ConfirmImpact = "Low"
	,
	HelpURI = 'http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-AuditTrail/'
	,
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Get-AuditTrail; } 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQULicDPFz7kInZLVTjlf+Y4tTj
# qZugghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQ93qlsVdgVnfW/+niB
# JYSqN2mWeDANBgkqhkiG9w0BAQEFAASCAQABQk9mjHWe+MH2K9P45s+4SLO2PbL5
# Uorh3cS7+L9LIuTorNhwjtOID4CxBsiQmBB5oKuyLK8Pq98RrCm+8ebNWzzyW3bn
# gLxtux5P9ItyCdnxAcPt7NBnqGCa3uRgBXRiIUlOaJOTuYPuLInc+VWWtCNyXA8h
# fBdCQEwL+K5OaUqnSv+YmDi469NyQ8rDw5nr9ybRt8ZKuUqjqJj0aX4adBq8MK4m
# yAjIR9ibYCzuY+ZRIXcqPR/fbJVKrtwG6G/BrmVDyx8vhiYcpwz9MTRI9mpForKl
# pdJ44yn2eo5y106bpocqAE3HKk/FWW5Ynr5N7LvLhgIhJDaqMedrPO7poYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE1MDEx
# NDA5Mjc1OFowIwYJKoZIhvcNAQkEMRYEFCSR0IsERVKGb3AOsD/GdQSW6UwrMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQAa1QOD/VWP5Z/m1jg1Nbgl
# NFZyTgoZTACdQWamQJED0qk4yvjRTLVgPYF/hVRH04CGWEh24vH2vm3kJiEYcH9i
# POFKw7t7t9tn1+XdGyXYQQMEPHFK/bIEUW+n7dkz+CJvsIZSklB3efIhjHFggEPE
# vWGiOg5bFjxY5WNkk8FnRyZeK8wBhN1Yzv5e/Yp9aYpPv7lLHg2g3lN/1T48J6El
# wD3530opR4V+9/0C2kzEc+n/rkW3p1qKO8rO5gYRGXIdmI9b4rb0a2JkVuPNzGep
# wj0t7BV2ahP8S7vdi6r6KTfvJPMn25shV8pUajyrwWQEbeSKCqez8vCklApHYNN7
