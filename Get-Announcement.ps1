...
<#
.SYNOPSIS
Retrieves one or more entities from the Announcement entity set.
...
.EXAMPLE
Get-Announcement -ListAvailable -Select Name

Retrieves the name of all Announcements.


.EXAMPLE
Get-Announcement myvCenter -Select Description -ValueOnly -ConvertFrom-Json

Retrieves the Announcement 'myvCenter' and only returns the 'Description' property 
of it. In addition the contents of the property will be converted from JSON.


.EXAMPLE
Get-Announcement -ListAvailable -Select Name -First 3

Retrieves the name of the first 3 Announcements.


.EXAMPLE
Get-Announcement 4005 -Select Name -ValueOnly

Retrieves the name of the Announcement with Id 4005.


.EXAMPLE
Get-Announcement -ModifiedBy Administrator -Select Id, Name

Retrieves Id and Name of all Announcements that have been modified by user 
with name 'Administrator' (case insensitive substring match).


.EXAMPLE
Get-Announcement HotNews -Select Value -ValueOnly -DefaultValue "Nothing new"

Retrieves the 'Value' property of a Announcement with Name 'HotNews' 
and "Nothing new" if the entity is not found.


.LINK
Online Version: http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-Announcement/
...
[CmdletBinding(
    ...
    ConfirmImpact = "Low"
	,
	HelpURI = 'http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-Announcement/'
	,
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUFTMS5/CTqFpYP0iFJv0TZU8o
# IqagghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBR0xYldBOTdrFSZmTYl
# m3HvXauAijANBgkqhkiG9w0BAQEFAASCAQCN+VXzr9/EnASL9NxQdGQ6/KMO44rZ
# fGrLdMhWDIZjwq7iwrwBOEPewtV7pH7MFvZGiBJUlfF6rHReOR70XTvUXVn4/0zp
# 1aPJqVtdKEKXfhZTrkHaKtpDbZokrevnRt0ORcVfG6usCqeOB8+/1BQo6ct+Q43e
# ZcL3OILQizoOmaxyWHBFrc1kGj5Wapg1iapv/fXaLAKmJtM7s3s3yZkMUH98szYb
# pfxuIPaVslaRfF3wi19ul11dHmi6KNcX0CVlXTJKVvvyixOSlet6EfE83Z2vIt6J
# P7bv07LbCF2ba+ZeOhrm9EjaDCpGrMffrzgZn+e49L1eWcxqAXjUNCrioYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE1MDEx
# NDA5Mjc1N1owIwYJKoZIhvcNAQkEMRYEFMHR1oCNLsHvL9QB9DxUBNoaDsMYMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQBhaaHnGd7G8XSYcBoIldX+
# gYkC7VWWQfnBQPjcKZCFxNjImnx8j3yTK7l0TVb+ZEjoEH0QyF62QuttPnOmv3Cr
# dF3ukT8FbGppXZ0Pnypze0zbWInwXTC1njhVnjZFrS7OCKJ4eO/Mg85IJZnwmBar
# hM86MjhrSdyEdwJ0V8ePL1h2QdU30RxWg6lxV05fE4R+fk7tV7K+BDU+YlrxdRry
# clKtjs6JXzM4triJ1W7QIolgCpPnaUhS1swkAtEHwcLVy16hljjn5Y5GPGk2F2wP
# DPZEmUEZX8Weo1USJy1lj4xY27+tm9Pr+oby/rNT+Tw1H+Xpy8nt2Esb7g1fUkrN
