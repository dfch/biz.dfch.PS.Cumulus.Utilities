...
<#
.SYNOPSIS
Retrieves one or more entities from the Address entity set.
...
Name, Value or other properties.
...
.EXAMPLE
Get-Address -ListAvailable -Select Name

Retrieves the name of all Addresses.


.EXAMPLE
Get-Address PingTest -Select Parameters -ValueOnly -ConvertFrom-Json

Retrieves the Address 'PingTest' and only returns the 'Parameters' property 
of it. In addition the contents of the property will be converted from JSON.


.EXAMPLE
Get-Address -ListAvailable -Select Name -First 3

Retrieves the name of the first 3 Addresses.


.EXAMPLE
Get-Address 4005 -Select Name -ValueOnly

Retrieves the name of the Address with Id 4005.


.EXAMPLE
Get-Address -ModifiedBy Administrator -Select Id, Name

Retrieves Id and Name of all Addresses that have been modified by user 
with name 'Administrator' (case insensitive substring match).


.EXAMPLE
Get-Address PingTest -Select Parameters -ValueOnly -DefaultValue 42

Retrieves the 'Parameters' property of a Command with Name 'PingTest' 
and 42 if the entity is not found.


.LINK
Online Version: http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-Address/
...
[CmdletBinding(
    ...
    ConfirmImpact = "Low"
	,
	HelpURI = 'http://dfch.biz/biz/dfch/PS/Cumulus/Utilities/Get-Address/'
	,
...
if($MyInvocation.ScriptName) { Export-ModuleMember -Function Get-Address; } 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUnIW8LKaYwlvt4A17G5ZxH5y+
# ykigghGYMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# AQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTgUlcrTF+GRIhpmrB8
# gxoVBEqGRjANBgkqhkiG9w0BAQEFAASCAQAZ1WiEb7nmZtNkJGL+NTWfGP114kfj
# kTYWFdryIheyZnWpi5yerciYc/NLpxEnbEij3BdPM489KfSpNSJgJPG32LTJTc+m
# U2syaSfqiEcvmH0MFWxSm09/X+GYV+FzkcdqgyrsBVo1AUVoD9lIl9UBqt06Sbf2
# 1oR1KmdOFiyoquCwP3RwjqSuM50qLDZ9upRRIHopRVl/nNCOsUOQ1+SZRG63eHfW
# H5ynwy41DrPjDRycTLpTshN8vWvK3SkCy1RiRjTW/u4q7cO3jf5cfl6zcxvp7qE+
# SdS9RDeqPfzajPTOZzANW+W5EtabYH63RJ/JIDWMY7bd2/uZkz4QoZnvoYICojCC
# Ap4GCSqGSIb3DQEJBjGCAo8wggKLAgEBMGgwUjELMAkGA1UEBhMCQkUxGTAXBgNV
# BAoTEEdsb2JhbFNpZ24gbnYtc2ExKDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0
# YW1waW5nIENBIC0gRzICEhEhQFwfDtJYiCvlTYaGuhHqRTAJBgUrDgMCGgUAoIH9
# MBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE1MDEx
# MzE4NDE0N1owIwYJKoZIhvcNAQkEMRYEFCkg7JF7thbq94G/QihyfBE46NmrMIGd
# BgsqhkiG9w0BCRACDDGBjTCBijCBhzCBhAQUjOafUBLh0aj7OV4uMeK0K947NDsw
# bDBWpFQwUjELMAkGA1UEBhMCQkUxGTAXBgNVBAoTEEdsb2JhbFNpZ24gbnYtc2Ex
# KDAmBgNVBAMTH0dsb2JhbFNpZ24gVGltZXN0YW1waW5nIENBIC0gRzICEhEhQFwf
# DtJYiCvlTYaGuhHqRTANBgkqhkiG9w0BAQEFAASCAQA6HDiJcG1ak5Md0iL0v9P0
# MH8u0UabvSAJ+t0dUey8V35pGzLLtXgSXWYVghXL4xvA6hpKd5VRcrQ3zXGpl0Er
# wo3ET3giWrum98oQ1kS565D7Q6uMoori/QoatNIyq3sjJCnp6VjspsEfBAIefzvZ
# DDywYFO28utMYg+PiVafbLE3w2GvwQHfQA44mPLSUIQFqygAXhSCa8Rh+wNeQI9H
# Ey7OYwvU1btOtjETPExDzyHvkvScmPLlTPDjt4FumafMew7qwNcAPgOKtzfxyl32
# hcA556Jq8dOf5uP+sLIXNM02SMHbXsilXZy8npibqjZirDJ1iRisEbSy9IZXQrjo
